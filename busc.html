                    ...
                    <li>
                      <div class="container">
                        <div class="row">
                          <div class="col">
                            <div class="img">
                              <a href="perfil.html"><img src="img/review/portada3.jpg" width="275" height="140"></a>
                              <span class="badge badge-ps4">Librería: BúhoBooks</span>
                            </div>
      ...
      <div class="navbar-search">
        <div class="container">
          <form method="post" action="buscar.php">
            <input type="text" data-toggle="modal" data-target="#terms" name="buscar" class="form-control" placeholder="Búscar..." onkeypress="13" required="">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib1.jpg" class="card-img-top"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib2.jpg" class="card-img-top"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib3.jpg" class="card-img-top"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib4.jpg" class="card-img-top"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib5.jpg" class="card-img-top"></a>
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="card card-lg">
            <div class="card-img">
              <a href="#"><img src="img/game/lib6.jpg" class="card-img-top"></a>
